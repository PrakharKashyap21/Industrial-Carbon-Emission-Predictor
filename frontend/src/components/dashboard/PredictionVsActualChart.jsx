    ...
    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-4">
      ...
      <div className="space-y-3 pt-2 overflow-hidden">
        <div className="overflow-x-auto pb-2">
          <div className="h-56 min-w-[500px] sm:min-w-full flex items-end justify-between space-x-1 sm:space-x-1.5 pt-14 pb-2 border-b border-slate-200 relative overflow-visible">
